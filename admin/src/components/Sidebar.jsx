  ...
  return (
    <div className='w-[10%] min-h-screen border-r-2'>
      <div className='flex flex-col gap-4 pt-6 pl-[20%] text-[15px]'>
        ...
        <NavLink className='flex items-center gap-3 border border-gray-300 border-r-0 px-3 py-2 rounded-1' to='/category'>
          <img className='w-5 h-5' src={assets.order_icon} alt='' />
          <p className='hidden md:block'>Quản lý danh mục</p>
        </NavLink>
      </div>
      <div className='flex flex-col gap-4 pt-2 pl-[20%] text-[15px]'>
        <NavLink className='flex items-center gap-3 border border-gray-300 border-r-0 px-3 py-2 rounded-1' to='/stats'>
          <img className='w-5 h-5' src={assets.order_icon} alt='' />
